    ...
    s.mywibox:setup {
	{
        ...
        { -- Right widgets
           ...
           -- wibox.container.background(wibox.container.margin(wibox.widget { mailicon, mail and mail.widget, layout = wibox.layout.align.horizontal }, 4, 7), "#343434"),
            ...
            -- arrow("#7197E7", "#A77AC4"),
            wibox.container.background(wibox.container.margin(wibox.widget { spotify_widget(), layout = wibox.layout.align.horizontal }, 3, 3), "#1DB954"),
            arrow("#1DB954", "#A77AC4"),
            ...
            -- wibox.container.background(wibox.container.margin(wibox.widget { volicon, volumebar_widget({
                 										-- main_color = '#af13f7',
												-- main_color = '#7197E7',
             											-- mute_color = '#ff0000',
             											-- width = 50,
             											...
             											-- margins = 6
         								     -- }), layout = wibox.layout.align.horizontal }, 2, 3), "#A77AC4"),
            arrow("#A77AC4", "#7197E7"),
            ...
            arrow("#7197E7", "#A77AC4"),
            wibox.container.background(wibox.container.margin(wibox.widget { cpu_widget(), layout = wibox.layout.align.horizontal }, 3, 3), "#A77AC4"),
            arrow("#A77AC4", "#7197E7"),
            ...
            wibox.container.background(wibox.container.margin(wibox.widget { todo_widget(), layout = wibox.layout.align.horizontal }, 3, 3), "#A77AC4"),
            arrow("#A77AC4", "#7197E7"),
