...
awful.util.tagnames = { "WWW", "Dev", "Sys", "Docs", "Music", "Files", "Apps", "Vbox", "Chat"}
...
globalkeys = my_table.join(
    ...
    -- Logout
    awful.key({ modkey, "Control" }, "l", function() logout.launch({
    	      bg_color = "#261447", accent_color = "#ff4365", text_color = '#f706cf', icon_size = 20, icon_margin = 12, -- outrun
    	      ...
    	      phrases = {"exit(0)", "Don't forget to be awesome.", "Yippee ki yay!", "You really leaving me and going?"},
...
-- }}}
--
-- to spawn with client restart or login
...
--
-- adding offset to windows using lain
